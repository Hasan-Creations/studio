  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 py-8">
        <h1 className="text-4xl font-bold tracking-tight mb-12 text-center text-primary">
          Discover Our Arty Furniture
        </h1>

        <section id="sofas" className="mb-12 scroll-mt-16">
        ...
        <section id="chairs" className="mb-12 scroll-mt-16">
        ...
        <section id="tables" className="mb-12 scroll-mt-16">
